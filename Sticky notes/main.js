...
function createNotes(title, description)
{
    ...
    $('.sticky_notes').append('<li class="'+colours[randomFromTo(0,(colours.length - 1))]+'">'+header+"<div style='background:url(linie.jpg); height: auto;'>"+emoji[randomFromTo(0,(emoji.length - 1))]+description+"</div>"+'</li>');
}
